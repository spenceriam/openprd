...
```bash
git remote add encore encore://openprd-app-ee92
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/openprd-app-ee92/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/openprd-app-ee92/settings/integrations/github)
